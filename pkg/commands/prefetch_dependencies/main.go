...
var ParamsConfig = map[string]common.Parameter{
	...
	"env-file": {
		...
		Usage:        "file where to write necessary environment variables for hermetic build",
		Required:     false,
	},
	"rhsm-org": {
		Name:         "rhsm-org",
		TypeKind:     reflect.String,
		DefaultValue: "",
		Usage:        "file with the Red Hat Subscription Manager organization ID",
		Required:     false,
	},
	"rhsm-activation-key": {
		...
		TypeKind:     reflect.String,
		DefaultValue: "",
		Usage:        "file with the Red Hat Subscription Manager activation key",
		Required:     false,
	},
}

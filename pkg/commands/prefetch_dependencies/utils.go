...
// TODO: This could be shared with the buildah command.
...
func CopyGitAuthFiles() error {
	if os.Getenv("WORKSPACE_GIT_AUTH_BOUND") == "true" {
		workspace := os.Getenv("WORKSPACE_GIT_AUTH_PATH")
		home := os.Getenv("HOME")
...
// TODO: This could be shared with the git-clone command.
func GenerateGitAuthContent(sourceDir string) error {
